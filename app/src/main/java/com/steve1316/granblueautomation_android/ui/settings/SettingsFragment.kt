...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    private val itemsForSpecial = mapOf(
        "Scarlet Trial" to arrayListOf("Fire Orb", "Water Orb", "Earth Orb", "Wind Orb", "Light Orb", "Dark Orb", "Inferno Orb", "Frost Orb",
            "Rumbling Orb", "Cyclone Orb", "Shining Orb", "Abysm Orb"),
        "Cerulean Trial" to arrayListOf("Red Tome", "Blue Tome", "Brown Tome", "Green Tome", "White Tome", "Black Tome", "Hellfire Scroll",
        ...
        "Six Dragon Trials" to arrayListOf("Red Dragon Scale", "Blue Dragon Scale", "Brown Dragon Scale", "Green Dragon Scale", "White Dragon Scale",
            "Black Dragon Scale"),
        ...
        "Vohu Manah Showdown" to arrayListOf("Scrutiny Stone", "Luminous Judgment", "Evil Judge Crystal", "Vohu Manah Anima",
            "Vohu Manah Omega Anima"),
        "Sagittarius Showdown" to arrayListOf("Sagittarius Arrowhead", "Sagittarius Rune", "Horseman's Plate", "Sagittarius Anima",
    ...
    private val itemsForCoop = mapOf(
        ...
        "EX2-2 Time of Judgement" to arrayListOf("Evil Judge Crystal", "Pilgrim Distinction", "Mage Distinction", "Alchemist Distinction",
            "Monk's Distinction", "Keraunos Replica", "Faust Replica"),
        "EX2-3 Time of Revelation" to arrayListOf("Infernal Garnet", "Gladiator Distinction", "Fencer Distinction", "Dual Wielder Distinction",
            "Forester's Distinction", "Avenger Replica", "Hellion Gauntlet Replica"),
        "EX2-4 Time of Eminence" to arrayListOf("Halo Light Quartz", "Bandit Distinction", "Troubadour Distinction", "Mystic Distinction",
            "Shredder Distinction", "Nirvana Replica", "Romulus Spear Replica", "Murakumo Replica"),
        "EX3-2 Rule of the Tundra" to arrayListOf("Frozen Hell Prism", "Guardian Distinction", "Combatant Distinction", "Sword Master Distinction",
            "Dragoon's Distinction", "Skofnung Replica", "Langeleik Replica", "Kapilavastu Replica"),
        "EX3-3 Rule of the Plains" to arrayListOf("Horseman's Plate", "Sharpshooter Distinction", "Cavalryman Distinction", "Gunslinger Distinction",
            "Oliver Replica", "Rosenbogen Replica", "Misericorde Replica"),
        "EX3-4 Rule of the Twilight" to arrayListOf("Phantom Demon Jewel", "Samurai Distinction", "Ninja Distinction", "Assassin Distinction",
            "Ipetam Replica", "Proximo Replica", "Nebuchad Replica", "Muramasa Replica"),
        "EX4-2 Amidst the Waves" to arrayListOf("Pilgrim Distinction", "Mage Distinction", "Alchemist Distinction", "Mystic Distinction",
            "Monk's Distinction", "Oliver Replica", "Langeleik Replica", "Romulus Spear Replica", "Proximo Replica", "Kapilavastu Replica"),
        "EX4-3 Amidst the Petals" to arrayListOf("Sharpshooter Distinction", "Samurai Distinction", "Ninja Distinction", "Gunslinger Distinction",
            "Assassin Distinction", "Longstrider's Distinction", "Langeleik Replica", "Misericorde Replica", "Faust Replica"),
        "EX4-4 Amidst Severe Cliffs" to arrayListOf("Gladiator Distinction", "Fencer Distinction", "Combatant Distinction", "Sword Master Distinction",
            "Aschallon Replica", "Hellion Gauntlet Replica", "Muramasa Replica", "Practice Drum"),
        "EX4-5 Amidst the Flames" to arrayListOf("Guardian Distinction", "Bandit Distinction", "Troubadour Distinction", "Cavalryman Distinction",
            "Dragoon's Distinction", "Ipetam Replica", "Murakumo Replica", "Nebuchad Replica")
    )
    
    private val itemsForRaid = mapOf(
        "Tiamat Omega" to arrayListOf("Tiamat Omega", "Tiamat Anima", "Tiamat Omega Anima", "Tiamat Amood Omega", "Tiamat Bolt Omega",
            "Tiamat Gauntlet Omega", "Tiamat Glaive Omega"),
        "Colossus Omega" to arrayListOf("Colossus Omega", "Colossus Anima", "Colossus Omega Anima", "Colossus Blade Omega", "Colossus Cane Omega",
            "Colossus Carbine Omega", "Colossus Fist Omega"),
        "Leviathan Omega" to arrayListOf("Leviathan Omega", "Leviathan Anima", "Leviathan Omega Anima", "Leviathan Bow Omega", "Leviathan Gaze Omega",
            "Leviathan Scepter Omega", "Leviathan Spear Omega"),
        "Yggdrasil Omega" to arrayListOf("Yggdrasil Omega", "Yggdrasil Anima", "Yggdrasil Omega Anima", "Yggdrasil Bow Omega",
            "Yggdrasil Crystal Blade Omega", "Yggdrasil Dagger Omega", "Yggdrasil Dewbranch Omega"),
        "Luminiera Omega" to arrayListOf("Luminiera Omega", "Luminiera Anima", "Luminiera Omega Anima", "Luminiera Bhuj Omega", "Luminiera Bolt Omega",
            "Luminiera Harp Omega", "Luminiera Sword Omega"),
        "Celeste Omega" to arrayListOf("Celeste Omega", "Celeste Anima", "Celeste Omega Anima", "Celeste Harp Omega", "Celeste Claw Omega",
        ...
        "Godsworn Alexiel" to arrayListOf("Alexiel Anima", "Alexiel Omega Anima", "Nibelung Horn", "Nibelung Klinge", "Nibelung Messer",
            "Godsworn Edge"),
        "Grimnir" to arrayListOf("Grimnir Anima", "Grimnir Omega Anima", "Last Storm Blade", "Last Storm Harp", "Last Storm Lance",
            "Coruscant Crozier"),
        "Metatron" to arrayListOf("Metatron Anima", "Metatron Omega Anima", "Mittron's Treasured Blade", "Mittron's Gauntlet", "Mittron's Bow",
            "Pillar of Flame"),
