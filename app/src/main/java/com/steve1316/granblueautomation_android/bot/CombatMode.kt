...
class CombatMode(private val game: Game) {
	...
	fun startCombatMode(combatScript: List<String>): Boolean {
		try {
			...
			var i = 0 // Current index for the current command from the combat script.
			var turnNumber = 1 // Current Turn number for script execution.
			...
			game.printToLog("[ERROR] Encountered exception during Combat Mode: ${e.printStackTrace()}", MESSAGE_TAG = TAG)
		}
